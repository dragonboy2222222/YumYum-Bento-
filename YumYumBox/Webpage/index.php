        ...
        <div class="d-flex w-100 justify-content-between align-items-center">
                ...
                <li class="nav-item dropdown d-none d-lg-block">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="lunchboxDropdown2">
                        <?php foreach ($lunchboxes as $lunchbox): ?>
                            <li><a class="dropdown-item" href="customer/lunchbox.php?id=<?= $lunchbox['id'] ?>"><?= htmlspecialchars($lunchbox['name']) ?></a></li>
                        <?php endforeach; ?>
                    </ul>
                </li>
                <li class="nav-item dropdown d-none d-lg-block">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="lunchboxDropdown">
                        <?php foreach ($lunchboxes as $lunchbox): ?>
                            <li><a class="dropdown-item" href="customer/menus.php?lunchbox_id=<?= $lunchbox['id'] ?>"><?= htmlspecialchars($lunchbox['name']) ?></a></li>
                        <?php endforeach; ?>
                    </ul>
                </li>
                <li class="nav-item d-none d-lg-block"><a class="nav-link" href="customer/aboutus.php">About Us</a></li>
                <li class="nav-item d-none d-lg-block"><a class="nav-link" href="customer/reviews.php">Reviews</a></li>
                <li class="nav-item d-none d-lg-block"><a class="nav-link" href="customer/faq.php">FAQ</a></li>
            </ul>
            ...
            <div class="collapse navbar-collapse" id="navbarMenu">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item d-lg-none"><a class="nav-link" href="customer/aboutus.php">About Us</a></li>
                    <li class="nav-item d-lg-none"><a class="nav-link" href="customer/reviews.php">Reviews</a></li>
                    <li class="nav-item d-lg-none"><a class="nav-link" href="customer/faq.php">FAQ</a></li>
...
<main class="container-fluid px-0">
    ...
    <section class="row align-items-center g-0" style="background-color:#f8f4ec;">
        ...
        <div class="col-md-6 p-5 d-flex flex-column justify-content-center">
            ...
            <a href="customer/bentoplans.php" class="btn btn-primary btn-lg" style="background-color:#cc3300; border:none;">
                Subscribe Now
            </a>
        </div>
    </section>
...
<section class="container py-5">
    <div class="row align-items-center g-4">
        ...
        <div class="col-md-6">
            ...
            <a href="customer/bentoplans.php" class="btn btn-primary btn-lg">
                SUBSCRIBE NOW
            </a>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                ...
                <ul class="list-unstyled mb-0">
                    <li><a href="customer/term.php" class="text-white">Terms and Conditions</a></li>
                    <li><a href="customer/policy.php" class="text-white">Privacy Policy</a></li>
                    <li><a href="customer/aboutus.php" class="text-white">About Us</a></li>
                    <li><a href="customer/faq.php" class="text-white">FAQ</a></li>
                </ul>
            </div>
            <div class="col-lg-3 col-md-6 mb-4">
